        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-16 animate-slide-up">
              Discover Yoga <span className="text-purple-500">Benefits</span>
            </h2>
              ...
              {[
                {
                  ...
                  description: "Learn from certified yoga teachers and wellness experts",
                },
                {
                  icon: "🌍",
                  title: "Global Styles",
                  description: "Explore authentic yoga traditions from around the world",
                },
                {
                  icon: "🕉️",
