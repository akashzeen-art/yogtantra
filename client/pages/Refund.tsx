      ...
      <div className="relative z-20">
        ...
        <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md rounded-xl p-8 text-white">
            ...
            <p className="text-sm text-white/60 mb-8">Last Updated: 09-07-2025</p>
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/90">
              ...
              <h2 className="text-2xl font-bold text-white mt-8">Scenarios Where Refunds Would Typically Be Granted</h2>
              ...
              <h2 className="text-2xl font-bold text-white mt-8">Scenarios Where Refunds Would Not Typically Be Granted</h2>
              <ul className="list-disc pl-6 space-y-1">
